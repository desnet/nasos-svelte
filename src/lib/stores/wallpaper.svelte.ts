...
export const WALLPAPERS: Wallpaper[] = [
  ...
  },
  {
    ...
    thumb:
      'linear-gradient(160deg, #0a0a2e 0%, #1a4a3a 30%, #2a8a5a 55%, #4aaa7a 70%, #1a3a5a 100%)'
  },
  {
    id: 'sunset',
    name: 'Закат',
    ...
    thumb:
      'linear-gradient(180deg, #1a0a2e 0%, #6a1a4a 25%, #c04a20 55%, #e08030 75%, #f0b060 100%)'
  },
  {
    id: 'ocean',
    name: 'Океан',
    ...
    thumb:
      'linear-gradient(180deg, #001a3a 0%, #003a6a 30%, #0060a0 60%, #0080c0 80%, #00a0d0 100%)'
  },
  {
    id: 'forest',
    name: 'Лес',
    ...
    thumb:
      'linear-gradient(180deg, #0a1a0a 0%, #1a3a1a 25%, #2a5a2a 55%, #3a7a3a 80%, #4a8a4a 100%)'
  },
  {
    id: 'volcano',
    name: 'Вулкан',
    ...
    thumb:
      'linear-gradient(180deg, #0a0a0a 0%, #2a0a0a 30%, #6a1a00 55%, #c04000 75%, #e06000 100%)'
  },
  {
    id: 'purple-dream',
    name: 'Фиолетовый сон',
    ...
    thumb:
      'linear-gradient(135deg, #0d0d2e 0%, #1a0a3a 30%, #3a1a6a 60%, #6a2a9a 85%, #8a3aba 100%)'
  },
  {
    id: 'rose-gold',
    name: 'Розовое золото',
    ...
    thumb:
      'linear-gradient(135deg, #2a1a1a 0%, #4a2a2a 30%, #8a4a4a 55%, #c08060 75%, #e0b080 100%)'
  },
  {
    id: 'cyber',
    name: 'Киберпанк',
    ...
    thumb:
      'linear-gradient(135deg, #000a1a 0%, #001a2a 40%, #0a2a1a 60%, #001a00 80%, #0a0a0a 100%)'
  },
  {
    id: 'space',
    name: 'Космос',
