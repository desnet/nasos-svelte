<script lang="ts">
	...
	const time = $derived(now.toLocaleTimeString('ru-RU', { hour: '2-digit', minute: '2-digit', second: '2-digit' }))
	const date = $derived(now.toLocaleDateString('ru-RU', { weekday: 'long', day: 'numeric', month: 'long' }))
	...
	<div class="analog">
		<svg viewBox="0 0 100 100" class="face">
			...
			<line x1="50" y1="50"
				...
				stroke="#4a90d9" stroke-width="1" stroke-linecap="round"/>
...
<style>
	...
	.analog { width: 100px; height: 100px; }
